...
function synthesize_random_waveforms(opts) {
	var A=_MLS.runProcess('ephys.synthesize_random_waveforms',
		{},
		{
			waveforms_out:true,
			geometry_out:true
...
function synthesize_random_firings(opts) {
	var A=_MLS.runProcess('ephys.synthesize_random_firings',
		{},
		{
			firings_out:true
		},
...
function synthesize_timeseries(opts) {
	var A=_MLS.runProcess('ephys.synthesize_timeseries',
		{
