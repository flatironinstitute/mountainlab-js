...
async function main() {
  ...
  let dsdir='kbucket://3d22481b8598/synth_datasets/datasets/synth_tetrode_30min';

  await mountainsort4(MLC, dsdir, 'output', sort_params);
  await compare_ground_truth(MLC, dsdir, 'output');
}
